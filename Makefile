...
cppish: mips
	...
	${COMPILER} -o cpp_compiler cppish_ast.cmo cish_ast.cmo cppish_parse.cmo cish_parse.cmo cppish_lex.cmo cish_lex.cmo cish_eval.cmo word32.cmo mips.cmo cish_compile.cmo cish.cmo cppish.cmo
